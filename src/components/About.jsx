...
import dev_icon from '../assets/Ayush Saha_CSE_2026.pdf';
  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">I’m Ayush Saha, a frontend developer and Computer Science undergraduate with a strong foundation in web development and artificial intelligence.

Currently pursuing my B.Tech at MCKV Institute of Engineering, I’ve worked on diverse projects—from real-time traffic sign detection to AI-based skin cancer prediction—collaborating with academic institutions like Jadavpur University and completing internships under programs by Infosys and Microsoft-AICTE.
...
My interests lie in crafting responsive, user-centric web applications and solving real-world problems through machine learning. I’m always eager to learn, build, and contribute to impactful tech solutions.
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                ...
                ">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">C, Python Java, HTML, CSS, JavaScript React Js, Next Js </p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">B.Tech in Computer Science, MCKV Institute of Engineering </p>
                </li>
                <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                 ...
                 <li className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50">
                    ...
                    <h3 className="my-4 font-semibold text-gray-700 dark:text-white">Publication</h3>
                    <p className="text-gray-600 text-sm dark:text-white/80">2 International conference </p>
                </li>
            </ul>
            ...
            <ul className="flex items-center gap-3 sm:gap-5">
                ...
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
                    <img src={tensorflow} alt="" className="w-5 sm:w-7"/>
                </li>
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
                    <img src={Flask} alt="" className="w-5 sm:w-7"/>
                </li>
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
                    <img src={mongodb} alt="" className="w-5 sm:w-7"/>
                </li>
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
                    <img src={aws} alt="" className="w-5 sm:w-7"/>
                </li>
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
                    <img src={opencv} alt="" className="w-5 sm:w-7"/>
                </li>
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500">
